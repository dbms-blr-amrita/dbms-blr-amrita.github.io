        ...
        <div class="inner">
            <table>
                ...
                <tr>
                    ...
                    <td>Rs.</td>
                    <td>
                        <div id="1"><?php echo $row['bike_price'];?>/day</div>
                    </td>
                </tr>
                <tr>
                    <td>tax</td>
                    ...
                    <td>Rs.</td>
                    <td>
                        <div id="2"><?php echo $row['bike_price']/10; ?></div>
                    </td>
                </tr>
                <tr style="border-top: 1px solid black;">
                    ...
                    <td>Rs.</td>
                    <td>
                    <div id="3"><?php echo $row['bike_price']*110/100?>/day</div>
                    </td>
                </tr>
            </table>
        </div>
        <button type = "submit" class="btn one" onclick="checking_e(document.formz.Email.value);">Pay</button>
    </div>
    </form>
</body>
