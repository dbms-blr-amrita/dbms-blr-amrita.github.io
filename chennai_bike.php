...
<body>
    <?php
        ...
        $selectstmt = "SELECT bike_status FROM bike WHERE bike_name = 'Triump_t120' AND bike_location = 'chennai'";
        ...
        $selectstmt = "SELECT bike_status FROM bike WHERE bike_name = 'Bajaj_ns200' AND bike_location = 'chennai'";
        $result = $mysqli->query($selectstmt);
        ...
        $selectstmt = "SELECT bike_status FROM bike WHERE bike_name = 'RE_himalayan' AND bike_location = 'chennai'";
        $result = $mysqli->query($selectstmt);
        ...
        $selectstmt = "SELECT bike_status FROM bike WHERE bike_name = 'apache_rr310' AND bike_location = 'chennai'";
        $result = $mysqli->query($selectstmt);
        ...
        $selectstmt = "SELECT bike_status FROM bike WHERE bike_name = 'HD_iron_883' AND bike_location = 'chennai'";
        $result = $mysqli->query($selectstmt);
        ...
        if(isset($_POST['buy'])){
            $bike = $_POST['buy'];
            if($bike === "6"){
                $stmt = "UPDATE bike SET bike_status = 'y' WHERE id = 6";
                $stmt2 = "SELECT bike_price FROM bike WHERE id = 6";
                session_start();
                $_SESSION['sqlstmt'] = $stmt;
                $_SESSION['sqlstmt2'] = $stmt2;
                header("location: billing_bikes.php");
            ...
            if($bike === "7"){
                $stmt = "UPDATE bike SET bike_status = 'y' WHERE id = 7";
                $stmt2 = "SELECT bike_price FROM bike WHERE id = 7";
                session_start();
                $_SESSION['sqlstmt'] = $stmt;
                $_SESSION['sqlstmt2'] = $stmt2;
                header("location: billing_bikes.php");
            ...
            if($bike === "8"){
                $stmt = "UPDATE bike SET bike_status = 'y' WHERE id = 8";
                $stmt2 = "SELECT bike_price FROM bike WHERE id = 8";
                session_start();
                $_SESSION['sqlstmt'] = $stmt;
                $_SESSION['sqlstmt2'] = $stmt2;
                header("location: billing_bikes.php");
            ...
            if($bike === "9"){
                $stmt = "UPDATE bike SET bike_status = 'y' WHERE id = 9";
                $stmt2 = "SELECT bike_price FROM bike WHERE id = 9";
                session_start();
                $_SESSION['sqlstmt'] = $stmt;
                $_SESSION['sqlstmt2'] = $stmt2;
                header("location: billing_bikes.php");
            ...
            if($bike === "10"){
                $stmt = "UPDATE bike SET bike_status = 'y' WHERE id = 10";
                $stmt2 = "SELECT bike_price FROM bike WHERE id = 10";
                session_start();
                $_SESSION['sqlstmt'] = $stmt;
                $_SESSION['sqlstmt2'] = $stmt2;
                header("location: billing_bikes.php");
    ...
    <div class="bike_portfolio">
        <div id = "triumph" class="bike_polaroid">
            ...
            <div class="bike_book_now">
                ...
                <br>
                <br><br>
                <form action="chennai_bike.php" method="post">
