...
<body>
    <?php
        ...
        $selectstmt = "SELECT bike_status FROM bike WHERE bike_name = 'Triump_t120' AND bike_location = 'vishakapatnam'";
        ...
        $selectstmt = "SELECT bike_status FROM bike WHERE bike_name = 'Bajaj_ns200' AND bike_location = 'vishakapatnam'";
        $result = $mysqli->query($selectstmt);
        ...
        $selectstmt = "SELECT bike_status FROM bike WHERE bike_name = 'RE_himalayan' AND bike_location = 'vishakapatnam'";
        $result = $mysqli->query($selectstmt);
        ...
        $selectstmt = "SELECT bike_status FROM bike WHERE bike_name = 'apache_rr310' AND bike_location = 'vishakapatnam'";
        $result = $mysqli->query($selectstmt);
        ...
        $selectstmt = "SELECT bike_status FROM bike WHERE bike_name = 'HD_iron_883' AND bike_location = 'vishakapatnam'";
        $result = $mysqli->query($selectstmt);
        ...
        if(isset($_POST['buy'])){
            $bike = $_POST['buy'];
            if($bike === "21"){
                $stmt = "UPDATE bike SET bike_status = 'y' WHERE id = 21";
                $stmt2 = "SELECT bike_price FROM bike WHERE id = 21";
                session_start();
            ...
            if($bike === "22"){
                $stmt = "UPDATE bike SET bike_status = 'y' WHERE id = 22";
                $stmt2 = "SELECT bike_price FROM bike WHERE id = 22";
                session_start();
                $_SESSION['sqlstmt'] = $stmt;
                $_SESSION['sqlstmt2'] = $stmt2;
                header("location: billing_bikes.php");
            ...
            if($bike === "23"){
                $stmt = "UPDATE bike SET bike_status = 'y' WHERE id = 23";
                $stmt2 = "SELECT bike_price FROM bike WHERE id = 23";
                session_start();
                $_SESSION['sqlstmt'] = $stmt;
                $_SESSION['sqlstmt2'] = $stmt2;
                header("location: billing_bikes.php");
            ...
            if($bike === "24"){
                $stmt = "UPDATE bike SET bike_status = 'y' WHERE id = 24";
                $stmt2 = "SELECT bike_price FROM bike WHERE id = 24";
                session_start();
                $_SESSION['sqlstmt'] = $stmt;
                $_SESSION['sqlstmt2'] = $stmt2;
                header("location: billing_bikes.php");
            ...
            if($bike === "25"){
                $stmt = "UPDATE bike SET bike_status = 'y' WHERE id = 25";
                $stmt2 = "SELECT bike_price FROM bike WHERE id = 25";
                session_start();
                $_SESSION['sqlstmt'] = $stmt;
                $_SESSION['sqlstmt2'] = $stmt2;
                header("location: billing_bikes.php");
    ...
    <div class="bike_portfolio">
        <div id = "triumph" class="bike_polaroid">
            ...
            <div class="bike_book_now">
                ...
                <br>
                <br><br>
                <form action="vishakapatnam_bike.php" method="post">
