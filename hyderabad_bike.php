...
<body>
    <?php
        ...
        $selectstmt = "SELECT bike_status FROM bike WHERE bike_name = 'Triump_t120' AND bike_location = 'hyderabad'";
        ...
        $selectstmt = "SELECT bike_status FROM bike WHERE bike_name = 'Bajaj_ns200' AND bike_location = 'hyderabad'";
        $result = $mysqli->query($selectstmt);
        ...
        $selectstmt = "SELECT bike_status FROM bike WHERE bike_name = 'RE_himalayan' AND bike_location = 'hyderabad'";
        $result = $mysqli->query($selectstmt);
        ...
        $selectstmt = "SELECT bike_status FROM bike WHERE bike_name = 'apache_rr310' AND bike_location = 'hyderabad'";
        $result = $mysqli->query($selectstmt);
        ...
        $selectstmt = "SELECT bike_status FROM bike WHERE bike_name = 'HD_iron_883' AND bike_location = 'hyderabad'";
        $result = $mysqli->query($selectstmt);
        ...
        if(isset($_POST['buy'])){
            $bike = $_POST['buy'];
            if($bike === "11"){
                $stmt = "UPDATE bike SET bike_status = 'y' WHERE id = 11";
                $stmt2 = "SELECT bike_price FROM bike WHERE id = 11";
                session_start();
            ...
            if($bike === "12"){
                $stmt = "UPDATE bike SET bike_status = 'y' WHERE id = 12";
                $stmt2 = "SELECT bike_price FROM bike WHERE id = 12";
                session_start();
                $_SESSION['sqlstmt'] = $stmt;
                $_SESSION['sqlstmt2'] = $stmt2;
                header("location: billing_bikes.php");
            ...
            if($bike === "13"){
                $stmt = "UPDATE bike SET bike_status = 'y' WHERE id = 13";
                $stmt2 = "SELECT bike_price FROM bike WHERE id = 13";
                session_start();
                $_SESSION['sqlstmt'] = $stmt;
                $_SESSION['sqlstmt2'] = $stmt2;
                header("location: billing_bikes.php");
            ...
            if($bike === "14"){
                $stmt = "UPDATE bike SET bike_status = 'y' WHERE id = 14";
                $stmt2 = "SELECT bike_price FROM bike WHERE id = 14";
                session_start();
                $_SESSION['sqlstmt'] = $stmt;
                $_SESSION['sqlstmt2'] = $stmt2;
                header("location: billing_bikes.php");
            ...
            if($bike === "15"){
                $stmt = "UPDATE bike SET bike_status = 'y' WHERE id = 15";
                $stmt2 = "SELECT bike_price FROM bike WHERE id = 15";
                session_start();
                $_SESSION['sqlstmt'] = $stmt;
                $_SESSION['sqlstmt2'] = $stmt2;
                header("location: billing_bikes.php");
    ...
    <div class="bike_portfolio">
        <div id = "triumph" class="bike_polaroid">
            ...
            <div class="bike_book_now">
                ...
                <br>
                <br><br>
                <form action="hyderabad_bike.php" method="post">
