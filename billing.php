...
<body>
    <div class="out_form">
        <div class="inner">
            ...
            <form class="form_des" name="formz">
...
<script>
    var receive = localStorage.getItem("SendingToBillpage");
    document.getElementById('1').innerHTML = receive;
    document.getElementById('2').innerHTML = Number(document.getElementById('1').innerHTML * 0.18);
    document.getElementById('3').innerHTML = Number(document.getElementById('1').innerHTML) + Number(document.getElementById('2').innerHTML);
</script>
