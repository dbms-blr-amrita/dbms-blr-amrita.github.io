...
<body>
    <?php
        ...
        $selectstmt = "SELECT bike_status FROM bike WHERE bike_name = 'Triump_t120' AND bike_location = 'vijayawada'";
        ...
        $selectstmt = "SELECT bike_status FROM bike WHERE bike_name = 'Bajaj_ns200' AND bike_location = 'vijayawada'";
        $result = $mysqli->query($selectstmt);
        ...
        $selectstmt = "SELECT bike_status FROM bike WHERE bike_name = 'RE_himalayan' AND bike_location = 'vijayawada'";
        $result = $mysqli->query($selectstmt);
        ...
        $selectstmt = "SELECT bike_status FROM bike WHERE bike_name = 'apache_rr310' AND bike_location = 'vijayawada'";
        $result = $mysqli->query($selectstmt);
        ...
        $selectstmt = "SELECT bike_status FROM bike WHERE bike_name = 'HD_iron_883' AND bike_location = 'vijayawada'";
        $result = $mysqli->query($selectstmt);
        ...
        if(isset($_POST['buy'])){
            $bike = $_POST['buy'];
            if($bike === "16"){
                $stmt = "UPDATE bike SET bike_status = 'y' WHERE id = 16";
                $stmt2 = "SELECT bike_price FROM bike WHERE id = 16";
                session_start();
            ...
            if($bike === "17"){
                $stmt = "UPDATE bike SET bike_status = 'y' WHERE id = 17";
                $stmt2 = "SELECT bike_price FROM bike WHERE id = 17";
                session_start();
                $_SESSION['sqlstmt'] = $stmt;
                $_SESSION['sqlstmt2'] = $stmt2;
                header("location: billing_bikes.php");
            ...
            if($bike === "18"){
                $stmt = "UPDATE bike SET bike_status = 'y' WHERE id = 18";
                $stmt2 = "SELECT bike_price FROM bike WHERE id = 18";
                session_start();
                $_SESSION['sqlstmt'] = $stmt;
                $_SESSION['sqlstmt2'] = $stmt2;
                header("location: billing_bikes.php");
            ...
            if($bike === "19"){
                $stmt = "UPDATE bike SET bike_status = 'y' WHERE id = 19";
                $stmt2 = "SELECT bike_price FROM bike WHERE id = 19";
                session_start();
                $_SESSION['sqlstmt'] = $stmt;
                $_SESSION['sqlstmt2'] = $stmt2;
                header("location: billing_bikes.php");
            ...
            if($bike === "20"){
                $stmt = "UPDATE bike SET bike_status = 'y' WHERE id = 20";
                $stmt2 = "SELECT bike_price FROM bike WHERE id = 20";
                session_start();
                $_SESSION['sqlstmt'] = $stmt;
                $_SESSION['sqlstmt2'] = $stmt2;
                header("location: billing_bikes.php");
    ...
    <div class="bike_portfolio">
        <div id="HD" class="bike_polaroid">
            ...
            <div class="bike_book_now">
                ...
                <br>
                <br><br>
                <form action="vijayawada_bike.php" method="post">
